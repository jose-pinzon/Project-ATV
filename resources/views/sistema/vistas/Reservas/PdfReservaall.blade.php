...
<body>
    <div class="">
        <table width="100%" class="tabla1">
            ...
            <tr>
                <td align="center" style="font-size: 15px;  font-style:oblique;">Historial de reservas del {{$fechas['fecha_inicial']}} al {{$fechas['fecha_final']}} </td>
            </tr>
        ...
        <table width="100%" class="tabla3">
           ...
           <tr>
                <td width="20%" align="center"><span class="text">{{$reserva->fecha_reserva}}</span></td>
                <td width="35%" align="center"><span class="text">{{$reserva->nombres}} {{$reserva->apellidos}}</span></td>
